package com.linka39.graphUtilTwo;
...
public class GraphMatrix {
     ...
     *     matrix-- 矩阵(数据)
     */
    public GraphMatrix(char[] vexs, int[][] matrix) {
   ...
   /* public void topology() {
        ...
        for (Character vex : mVexs) {// 遍历所有的点
            inMap.put(vex, node.in);// 所有点以及入度加入map
            if (node.in == 0) {
    ...
    public Integer setmEdgNum(char vex) {
    ...
    public static void main(String[] args) {
        ...
        //pG = new MatrixUDG();
        // 采用已有的"图"
        pG = new GraphMatrix(vexs, matrix);
